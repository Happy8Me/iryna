...
export default new Vuex.Store({
  state: {
    ...
    works: [ 
      ...
      {name: 'GPS', pic: '', text:'Coordinates distance calculator', additionalText: 'The application allows to calculate the distance between two locations. Each set of coordinates has a marker on the map.', link:'https://gps-react-express.herokuapp.com/'}, 
      ...
      {name: 'ToDo App', pic: '', text:'Regular ToDo application', additionalText: 'Add, mark as completed, sort, delete tasks.', link:'https://happy8me.github.io/toDoApp/'}, 
      {name: 'Movies', pic: '', text: 'Movies catalog with a search option', link:'https://happy8me.github.io/movies/'},
      {name: 'Posts & Albums', pic: '', text: 'Catalog of posts and albums with "add to favourite" option', link:'https://happy8me.github.io/posts_and_albums'},
